...
.. |commits-since| image:: https://img.shields.io/github/commits-since/svenseeberg/git-doccommit/v0.4.2.svg
    :alt: Commits since latest release
    :target: https://github.com/svenseeberg/git-doccommit/compare/v0.4.2...master
