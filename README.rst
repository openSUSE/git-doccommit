...
.. |commits-since| image:: https://img.shields.io/github/commits-since/svenseeberg/git-doccommit/v1.0.4.svg
    :alt: Commits since latest release
    :target: https://github.com/svenseeberg/git-doccommit/compare/v1.0.4...master
